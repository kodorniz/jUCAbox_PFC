...
export class UserService {
    ...
    public getCurrentUser(){
          ...
          console.log('user service',this.Usuario.getUserID());
    ...
    public getTokenApi(){
      ...
      let body = '';//'{"grant_type":"client_credentials","client_id": "bgbQ4SXSKq74fripNxkrMp24k2GF6409","client_secret": "Jq51Ixy0UQgbQ6h71l0gfYL7TH1t6faLU3MV4eq2ln8-2At5dFqgUH3lJNGt8KMh","audience": "https://sergioruiz.eu.auth0.com/api/v2/"}';
      this._http.post('https://sergioruiz.eu.auth0.com/oauth/token',credentials,options).map((res) => token = res.json());*/
